...
<template>
  <div class="waveContainer" @click="play">
    <img :src="require('@/assets/imgFlow/4.jpg')" alt="" style="display: none;" id="musicImg">
  ...
  methods:{
    ...
    initMusic:function(){
        if(this.musicContext==null){
          ...
          this.mediaElement = this.musicContext.createMediaElementSource(this.$store.state.audioElement);
    ...
    draw:function (){
      ...
      for(var i=0;i<this.barCount;i++){
        ...
        this.ctx.clearRect(this.barWidth*i,0,this.barWidth-1,300-currentData*0.8);
        this.ctx.clearRect(this.barWidth*i+this.barWidth-1,0,1,this.height);
      }
	  },
    start:function(){
